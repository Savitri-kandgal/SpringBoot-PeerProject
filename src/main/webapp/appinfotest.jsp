...
<body>
	...
	<form id="saveAppInfo" action="/onSaveAppInfo" method="post"></form>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label>Project Name</label> <input type="text" class="form-control"
						form="saveAppInfo" name="pName" required>
				</div>
				...
				<div class="form-group col-md-6">
					<label>Team Manager</label> <input type="text" class="form-control"
						form="saveAppInfo" name="tManager">
				</div>

				<div class="form-group col-md-6">
					<label>Last Release</label> <input type="date" class="form-control"
						form="saveAppInfo" name="lReleased">
				</div>

				<div class="form-group col-md-6">
					<label>Team Contact Email</label> <input type="email"
						class="form-control" form="saveAppInfo" name="tEmail" required>
				</div>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					<label>De-Commissioned</label> <select class="form-control"
						form="saveAppInfo" name="dComissined" required>
				...
				<div class="form-group col-md-6">
					<label>Developed Date</label> <input type="date"
						class="form-control" form="saveAppInfo" name="dDate">
				</div>
				<div class="form-group col-md-6">
